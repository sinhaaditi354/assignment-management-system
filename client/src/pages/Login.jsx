      ...
      <div className="glass-card w-full max-w-md p-8 md:p-10 rounded-2xl shadow-2xl relative z-10 transition-shadow duration-300">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm font-medium">
            Sign in to access your assignment dashboard
          </p>
        </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="glass-input w-full pl-10 pr-4 py-3 rounded-xl text-slate-800 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none transition-all font-medium text-sm"
              />
            </div>
          </div>
